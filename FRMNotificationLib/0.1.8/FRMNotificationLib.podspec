...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://MartynasKaz@bitbucket.org/MartynasKaz/frm-notificationlib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'MartynasKazemekas' => 'martynas.kazemekas@gmail.com' }
  s.source           = { :git => 'https://MartynasKaz@bitbucket.org/MartynasKaz/frm-notificationlib.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'FRMNotificationLib' => ['FRMNotificationLib/Assets/*.png']
  # }
